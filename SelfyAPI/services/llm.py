...
async def generate_flavor(event_id: str, version: str, base: str, tone: str, redis:RedisDep):
    prompt = f"Rewrite this scenario event for a life simulation game. Make the tone {tone}. Keep it crisp and under similar length of the original. Don't use em dash. Original: {base} Return the text directly."
